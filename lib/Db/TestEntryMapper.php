...
/** @template-extends QBMapper<TestEntry> */
class TestEntryMapper extends QBMapper {
	public function __construct(IDBConnection $db) {
		parent::__construct($db, 'pm_tests', TestEntry::class);
	}
	 ...
	 */
	public function find(int $id): TestEntry {
		$qb = $this->db->getQueryBuilder();
		$qb->select('*')
			->from($this->getTableName())
